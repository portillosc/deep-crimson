...
def main(mytimer: func.TimerRequest) -> None:
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            #flow = InstalledAppFlow.from_client_secrets_file('..\\bin\\credentials.json', SCOPES)
            flow = InstalledAppFlow.from_client_secrets_file(pathlib.Path(__file__).parent / 'credentials.json', SCOPES)
